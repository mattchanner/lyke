...
export const KIBBE_QUIZ_SECTIONS: KibbeQuizSection[] = [
  {
    ...
    description: 'The natural angles and lines of your build, independent of weight',
    questions: [
      {
        id: 'bone_1',
        sectionId: 'bone',
        prompt: 'How would you describe your overall natural lines?',
        subPrompt: 'Think about whether your overall lines feel sharper or softer',
        options: [
  ...
  },
  {
    ...
    description: 'How softness and muscle shape your figure at a natural, comfortable weight',
    questions: [
      {
        id: 'flesh_1',
        sectionId: 'flesh',
        prompt: "How would you describe your body's overall softness?",
        options: [
  ...
  },
  {
    id: 'face',
    title: 'Facial Lines',
    description: 'The overall impression of your face: sharper, softer, or balanced',
    questions: [
      {
        id: 'face_1',
        sectionId: 'face',
        prompt: 'How would you describe the overall impression of your face?',
        options: [
