...
public class ContentReportConfiguration : IEntityTypeConfiguration<ContentReport>
{
    public void Configure(EntityTypeBuilder<ContentReport> builder)
    {
        ...
        builder.Property(cr => cr.AdditionalDetails)
            .HasMaxLength(1000);
        ...
        builder.HasOne(cr => cr.ReportedByUser)
            .WithMany()
        ...
        builder.HasIndex(cr => new { cr.PostId, cr.ReportedByUserId })
            .IsUnique()
