...
public class BodyProfileFitPreferenceConfiguration : IEntityTypeConfiguration<BodyProfileFitPreference>
{
    public void Configure(EntityTypeBuilder<BodyProfileFitPreference> builder)
    {
        ...
        builder.Property(bpfp => bpfp.FitPreference)
            .HasConversion<string>()
            .HasMaxLength(20);

        builder.HasOne(bpfp => bpfp.BodyProfile)
