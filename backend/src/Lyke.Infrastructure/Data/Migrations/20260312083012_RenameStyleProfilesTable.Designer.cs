...
namespace Lyke.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260312083012_RenameStyleProfilesTable")]
    partial class RenameStyleProfilesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lyke.Core.Entities.MediaProcessingJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Lyke.Core.Entities.StyleProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BoneDominance")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<string>("FaceDominance")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<string>("FleshDominance")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<string>("OverrideFamily")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<DateTime?>("OverrideSetAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("RunnerUpFamily")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.ToTable("StyleProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("Lyke.Core.Entities.StyleProfile", b =>
                {
                    b.HasOne("Lyke.Core.Entities.User", "User")
                        ...
                        .HasForeignKey("Lyke.Core.Entities.StyleProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
